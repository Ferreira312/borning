...
RegisterServerEvent('esx_fire:MissionCompleted')
AddEventHandler('esx_fire:MissionCompleted', function()

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
  local total   = math.random(Config.MisEarnings.min, Config.MisEarnings.max);
